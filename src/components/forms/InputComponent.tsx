...
export default function InputComponent({ type, name, id, text }: {
    ...
    return (
        <div className="group w-full relative mb-3 text-primary dark:text-light border-2 border-gray-500 dark:border-gray-300 hover:border-primary dark:hover:border-secondary focus:border-primary dark:focus:border-secondary duration-300 ease-in-out rounded-lg py-1 bg-transparent">
            <input
                type={type}
                name={name}
                id={`${id}`}
