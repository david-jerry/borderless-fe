...
export default function WaitButton() {
    ...
    return (
        <>
            <button onClick={openWaitlist} type="button" className="flex items-center space-x-3 rounded-full py-2 px-5 bg-secondary dark:bg-transparent dark:border-2 dark:border-secondary text-primary dark:text-secondary">
